...
def calcularInforme(creditos: dict) -> list:
    ...
    for x in (creditos.keys()):
        ...
        num_cuota.append(creditos[list_cod[y]]['credito'][0]['cuotas'])
        ...
        valor_cuota = list_valor_credito[y] / num_cuota[y]
        vlr_cuota.append(valor_cuota)
    ...
    print("LISTADO CUOTAS (tiempo credito):", num_cuota)
    ...
    print("LISTADO VALOR CUOTA:", vlr_cuota)

    # ================ CALCULOS PARTICULARES CADA CREDITO:
    # ========================================= ////////////////////////////

    vlr_saldo = []
    for cod in list_cod:

        vlr_saldo.append(list_valor_credito[z]-vlr_cuota[z])

    print("saldo posicion cero: ", vlr_saldo)

    # CALCULO POSICION CERO EN TABLAS
