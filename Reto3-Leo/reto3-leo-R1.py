...
codigo_str = "".join(creditos.keys())
print("codigo_str:", codigo_str)  # testigo de que tomo codigo credito
...
def calcularInforme(creditos: dict) -> list:
    ...
    estado_credito = tuple  # La salida basica sin codigo usuario
    estado_credito.__add__(totPagados, totVencidos, totElaborados)

    salida_unidad = list()
    salida_unidad.append(codigoUsuarios, estado_credito)
